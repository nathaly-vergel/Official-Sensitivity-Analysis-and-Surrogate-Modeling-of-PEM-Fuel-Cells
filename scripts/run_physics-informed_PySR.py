...
model = PySRRegressor(
    ...
    combine="a(Tfc, i0_c_ref, Pa_des, kappa_c, kappa_co, tau, Re) - b(Tfc, i0_c_ref, Pa_des, kappa_c, kappa_co, tau, Re)*log(ifc) - c(Tfc, i0_c_ref, Pa_des, kappa_c, kappa_co, tau, Re)*ifc - d(Tfc, i0_c_ref, Pa_des, kappa_c, kappa_co, tau, Re)*log(1- ifc / e(Tfc, i0_c_ref, Pa_des, kappa_c, kappa_co, tau, Re))",
    )
)
